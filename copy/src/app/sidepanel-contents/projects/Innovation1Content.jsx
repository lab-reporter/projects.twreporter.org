...
const Innovation1Content = ({ projectData, onClose, setSelectedProject, setSidePanelContent }) => {
    if (!projectData) return null;

    return (
        <Shared.Container>
            <Shared.ReportBanner
                mediaSrc="https://www.twreporter.org/images/20231013145904-38a21191edd435f801ea99280ebb5c62-tablet.jpg"
                title="中國虎視下的島鏈"
            ...
            <Shared.Content>
                ...
                <Shared.SpotifyPlayer
                    urls={[
                        "https://open.spotify.com/embed/episode/7sop0uuX5STRVMxCTQqSx2?utm_source=generator&theme=0",
                        "https://open.spotify.com/embed/episode/6nB9YO8P76B5gtyF5VQHNX?utm_source=generator&theme=0"
                    ]}
                />

                {/* 完全客製化的影片 */}
                <Shared.VideoPlayer
                    urls={["/assets/數位敘事1.webm", "/assets/數位敘事3.mp4"]}
                    showControls={false}
                    autoPlay={true}
                    loop={true}
                    muted={true}
                ...
                {/* 閱讀完整專題按鈕 */}
                <Shared.BtnLink href="https://www.twreporter.org/topics/island-chain-under-chinas-coercion">
                    閱讀完整專題
                </Shared.BtnLink>
...
export default Innovation1Content; 