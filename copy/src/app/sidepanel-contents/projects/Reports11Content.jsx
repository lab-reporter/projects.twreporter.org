...
const Reports11Content = ({ projectData, onClose, setSelectedProject, setSidePanelContent }) => {
    if (!projectData) return null;

    return (
        <Shared.Container>
            <Shared.ReportBanner
                mediaSrc="https://www.twreporter.org/images/20240119020310-6a39502493e446450718750e033d0e64-desktop.jp"
                title="出口禁令下的紅線交易"
            ...
            <Shared.Content>
                ...
                {/* 閱讀完整專題按鈕 */}
                <Shared.BtnLink href="https://www.twreporter.org/a/taiwan-machine-tools-russia-war-investigation">
                    閱讀完整專題
                </Shared.BtnLink>
...
export default Reports11Content; 