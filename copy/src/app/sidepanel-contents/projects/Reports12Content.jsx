...
const Reports12Content = ({ projectData, onClose, setSelectedProject, setSidePanelContent }) => {
    if (!projectData) return null;

    return (
        <Shared.Container>
            <Shared.ReportBanner
                mediaSrc="/assets/獵童風暴：揭開未成年性剝削影像的暗黑產業鏈.mp4"
                title="獵童風暴"
            ...
            <Shared.Content>
                ...
                {/* 閱讀完整專題按鈕 */}
                <Shared.BtnLink href="https://www.twreporter.org/a/child-sexual-abuse-imagery-investigation">
                    閱讀完整專題
                </Shared.BtnLink>
...
export default Reports12Content; 