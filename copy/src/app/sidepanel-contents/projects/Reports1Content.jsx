...
const Reports1Content = ({ projectData, onClose, setSelectedProject, setSidePanelContent }) => {
    ...
    return (
        <Shared.Container>
            ...
            <Shared.Content>
                ...
                {/* 閱讀完整專題按鈕 */}
                <Shared.BtnLink href="https://www.twreporter.org/a/2023-09-11-chinese-foreign-students-in-taiwan-abuse-case">
                    閱讀完整專題
                </Shared.BtnLink>
...
export default Reports1Content; 