 ...
 * 項目2的專屬內容組件 - 標籤頁風格
 */
const Reports2Content = ({ projectData, onClose, setSelectedProject, setSidePanelContent }) => {
    ...
    return (
        <Shared.Container>
            ...
            <Shared.Content>
                ...
                {/* 閱讀完整專題按鈕 */}
                <Shared.BtnLink href="https://www.twreporter.org/a/indigenous-land-grab-taiwan">
                    閱讀完整專題
                </Shared.BtnLink>
...
export default Reports2Content; 