...
const Reports3Content = ({ projectData, onClose, setSelectedProject, setSidePanelContent }) => {
    if (!projectData) return null;

    return (
        <Shared.Container>
            <Shared.ReportBanner
                mediaSrc="https://www.twreporter.org/images/20210129175854-8652653532ed389c04f2e8a77e0302c3-tablet.jpg"
                title="造假．剝削．血淚漁場"
            ...
            <Shared.Content>
                ...
                {/* 閱讀完整專題按鈕 */}
                <Shared.BtnLink href="https://www.twreporter.org/a/far-sea-fishing-investigative-report">
                    閱讀完整專題
                </Shared.BtnLink>
...
export default Reports3Content; 