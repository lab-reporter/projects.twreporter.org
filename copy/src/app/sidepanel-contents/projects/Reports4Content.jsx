...
const Reports4Content = ({ projectData, onClose, setSelectedProject, setSidePanelContent }) => {
    if (!projectData) return null;

    return (
        <Shared.Container>
            <Shared.ReportBanner
                mediaSrc="https://www.twreporter.org/images/20171031114436-54bb2dde9a16363251f592edfbbd720d-tablet.jpg"
                title="廢墟裡的少年"
            ...
            <Shared.Content>
                ...
                {/* 閱讀完整專題按鈕 */}
                <Shared.BtnLink href="https://www.twreporter.org/a/youth-in-ruins-high-risk-families">
                    閱讀完整專題
                </Shared.BtnLink>
...
export default Reports4Content; 