...
const Reports5Content = ({ projectData, onClose, setSelectedProject, setSidePanelContent }) => {
    if (!projectData) return null;

    return (
        <Shared.Container>
            <Shared.ReportBanner
                mediaSrc="https://www.twreporter.org/images/20180123175443-aea7a0d9adceea44182a74f3fdc93c38-tablet.jpeg"
                title="六輕營運20年"
                subtitle="科學戰爭下的環境難民"
            />
            <Shared.Content>
                ...
                {/* 閱讀完整專題按鈕 */}
                <Shared.BtnLink href="https://www.twreporter.org/a/fpcc-20-years-environmental-refugees">
                    閱讀完整專題
                </Shared.BtnLink>
...
export default Reports5Content; 