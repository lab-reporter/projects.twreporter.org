...
const Reports6Content = ({ projectData, onClose, setSelectedProject, setSidePanelContent }) => {
    if (!projectData) return null;

    return (
        <Shared.Container>
            <Shared.ReportBanner
                mediaSrc="https://www.twreporter.org/images/20190830153732-72ae3e5b43e9ea7b2d666f6d3312e661-mobile.jpg"
                title="國家不願面對的真相"
                subtitle="獨家揭露台鐵體檢報告"
            />
            <Shared.Content>
                ...
                {/* 閱讀完整專題按鈕 */}
                <Shared.BtnLink href="https://www.twreporter.org/a/tra-safety-investigation-report">
                    閱讀完整專題
                </Shared.BtnLink>
...
export default Reports6Content; 