...
const Reports7Content = ({ projectData, onClose, setSelectedProject, setSidePanelContent }) => {
    if (!projectData) return null;

    return (
        <Shared.Container>
            <Shared.ReportBanner
                mediaSrc="https://www.twreporter.org/images/20180331181824-f1aae394ec3b005a31e5d913cef594d5-mobile.jpg"
                title="每天我們失去5個孩子"
                subtitle="搶救兒童高死亡率"
            />
            <Shared.Content>
                ...
                {/* 閱讀完整專題按鈕 */}
                <Shared.BtnLink href="https://www.twreporter.org/a/children-mortality-rate-taiwan">
                    閱讀完整專題
                </Shared.BtnLink>
...
export default Reports7Content; 