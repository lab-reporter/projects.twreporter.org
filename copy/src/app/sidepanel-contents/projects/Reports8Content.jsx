...
const Reports8Content = ({ projectData, onClose, setSelectedProject, setSidePanelContent }) => {
    if (!projectData) return null;

    return (
        <Shared.Container>
            <Shared.ReportBanner
                mediaSrc="https://www.twreporter.org/images/20190716105838-9acafe08db8b16069bf7affcbe4db9f1-mobile.jpg"
                title="看不見的線上博弈帝國"
            ...
            <Shared.Content>
                ...
                {/* 閱讀完整專題按鈕 */}
                <Shared.BtnLink href="https://www.twreporter.org/a/online-gambling-empire-investigative-report">
                    閱讀完整專題
                </Shared.BtnLink>
...
export default Reports8Content; 