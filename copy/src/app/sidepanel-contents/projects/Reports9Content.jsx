...
const Reports9Content = ({ projectData, onClose, setSelectedProject, setSidePanelContent }) => {
    if (!projectData) return null;

    return (
        <Shared.Container>
            <Shared.ReportBanner
                mediaSrc="https://www.twreporter.org/images/20200303092116-3424a123d896ea5de4936849b6bcd80b-mobile.jpg"
            ...
            <Shared.Content>
                ...
                {/* 閱讀完整專題按鈕 */}
                <Shared.BtnLink href="https://www.twreporter.org/a/nitrous-oxide-addiction-investigation">
                    閱讀完整專題
                </Shared.BtnLink>
...
export default Reports9Content; 