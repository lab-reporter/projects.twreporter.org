...
export default function Innovation1Content({ projectData, onNavigate, adjacentProjects }: ContentProps) {
  ...
  return (
    <Shared.Container>
      ...
      <div className="w-full h-[92vh] fixed top-0 left-0 z-0">
        <img src="/assets/challenges/challenge-bg.svg" alt="。" className="w-full h-full object-cover" />
      </div>
        ...
        <Shared.TextContent>
          ...
          <div className="space-y-4">
            ...
            <div className="img-container py-4">
              <img src="/assets/challenges/challenge-1/challenge-1-1.jpg" alt="2015年9月1日當天《報導者》成立記者會現場。" className="w-full h-auto" />
              <p className="mt-2 text-sm text-center text-gray-700">
                2015年9月1日當天《報導者》成立記者會現場。
              </p>
            </div>
            <p>
