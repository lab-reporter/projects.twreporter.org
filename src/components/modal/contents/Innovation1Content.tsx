  ...
  return (
    <div data-slide-container="true">
      ...
      >
        ...
        {/* 第五頁：創新意義 */}
        <Shared.InnovationSlide className="relative bg-gradient-to-br from-gray-50 to-gray-100">
          <Shared.SlideMedia
            type="image"
          ...
          <Shared.SlideTextCard
            ...
            className="absolute bottom-12 left-1/2 -translate-x-1/2 max-w-2xl shadow-2xl"
          />
        </Shared.InnovationSlide>
        {/* 第一頁：Banner */}
        <Shared.InnovationSlide>
