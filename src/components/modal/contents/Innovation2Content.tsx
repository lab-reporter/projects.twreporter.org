  ...
  return (
    <div data-slide-container="true">
      ...
      >
        ...
        {/* 第五頁：即時新聞創新 */}
        <Shared.InnovationSlide className="relative bg-gradient-to-br from-slate-900 to-slate-800">
          <Shared.SlideMedia
            type="video"
          ...
          <Shared.SlideTextCard
            ...
            className="absolute bottom-24 left-1/2 -translate-x-1/2 max-w-2xl"
          />
          <Shared.SlideTextCard
