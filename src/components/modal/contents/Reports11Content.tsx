...
export default function Reports11Content({ projectData, onNavigate: _onNavigate, adjacentProjects: _adjacentProjects, onClose }: ContentProps) {
        ...
        photos={[
          {
            ...
            width: { base: "60vw", sm: "40vw", md: "25vw", lg: "18vw" },
