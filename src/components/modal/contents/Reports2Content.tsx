      ...
      <Shared.ReportsParallaxPhoto
        photos={[
          ...
          },
          {
            ...
            position: {
              top: { base: "30%", sm: "22%", md: "18%", lg: "8%" },
              left: { base: "15%", sm: "30%", md: "40%", lg: "45%" },
              z: { base: 30, sm: 40, md: 50, lg: 60 }
            },
            width: { base: "60vw", sm: "45vw", md: "30vw", lg: "24vw", xl: "25vw" },
          ...
          },
          {
            ...
            position: {
              top: { base: "70%", sm: "60%", md: "50%", lg: "40%" },
              left: { base: "25%", sm: "40%", md: "50%", lg: "55%" },
              z: { base: 25, sm: 35, md: 42, lg: 70 }
            },
            width: { base: "70vw", sm: "55vw", md: "40vw", lg: "30vw", xl: "27vw" },
            visibility: { base: false, sm: true }
          }
        ]}
      />
      ...
      <Shared.ContentWrapper>
        ...
        <Shared.TextContent>
          <div className="space-y-4">
            ...
            <p>
              <Shared.TextContentLink href="https://www.twreporter.org/topics/aboriginal-reserve-dispute">專題報導</Shared.TextContentLink>
              推出後，直接影響最高法院民事大法庭於2021年9月17日做出重大裁定：「非原住民以借名登記、簽訂買賣契約、設定地上權及所有權轉移的行為，違反禁止規定，依《民法》第71條本文規定，應屬無效。」日後相關訴訟案件將統一見解，亦即宣告原保地假人頭買賣手法全部無效。
            </p>
            <p>
