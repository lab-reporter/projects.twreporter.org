...
export default function Reports9Content({ projectData, onNavigate: _onNavigate, adjacentProjects: _adjacentProjects, onClose }: ContentProps) {
        ...
        <Shared.TextContent>
          <div className="space-y-4">
            ...
            <p>
              ...
              刊出後促成經濟部工業局、環保署調整笑氣源頭管理的方式，並且研議相關法規。2020年10月，環保署正式公告將笑氣納入 《毒性及關注化學物質管理法》，網購笑氣、持有笑氣皆可處罰，並將對笑氣添加臭味，遏止吸食風氣；而台北市政府、桃園市政府亦針對笑氣制定行政規則與管理草案並加強稽查。
            </p>
          </div>
        </Shared.TextContent>
