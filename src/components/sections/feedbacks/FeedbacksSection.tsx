        ...
        >
          {quotes.map((quote) => (
            <SwiperSlide key={quote.id}>
              <div className="mx-auto w-[320px] h-[480px] bg-white text-gray-900 p-8 rounded-2xl shadow-xl flex flex-col justify-center items-center">
                <p className="mb-4 text-lg font-semibold leading-relaxed text-center">
                  {quote.text}
                </p>
