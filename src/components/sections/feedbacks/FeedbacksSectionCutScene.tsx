...
// 證言回饋頁面主要組件 (Cut Scene 版本)
export default function FeedbacksSectionCutScene() {
  // 使用滾動觸發器來監控當前頁面位置
  useScrollTrigger({
    // 對應的 HTML 元素 ID
  ...
  return (
    ...
    <section
      ...
      className="w-full h-screen text-white flex flex-col justify-center items-center relative z-[1]"
    >
      {/* 標題區域：頁面主要標題 */}
