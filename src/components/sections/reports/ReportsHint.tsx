...
export default function ReportsHint({
    ...
    return (
        ...
        >
            ...
            {/* 教學內容 */}
            <div className="relative text-white px-2 md:px-32 z-10 w-full h-full flex items-center justify-center">
                <div className="w-full flex-1 flex flex-col md:flex-row items-center px-2md:px-8 justify-center gap-2">
                    <Image
                ...
                <div className="w-full flex-1 flex flex-col md:flex-row items-center px-2 md:px-8 justify-center gap-2">
                    <Image
                ...
                {/* SectionNavigator側邊提示 */}
                <div className="hidden md:block border border-2 border-gray-500 absolute top-1/2 -translate-y-1/2 right-0 w-16 h-[22rem]">
                    <h6
